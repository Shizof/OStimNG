...
PlanckPluginAPI::IPlanckInterface001* PlanckPluginAPI::GetPlanckInterface001()
{
    ...
    skseMessaging->Dispatch(PlanckMessage::kMessage_GetInterface, (void*)&planckMessage, sizeof(PlanckMessage*),
                            "PLANCK");
